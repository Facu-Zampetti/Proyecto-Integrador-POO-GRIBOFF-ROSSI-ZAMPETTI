...
void RegisterWidget::setupUI()
{
    ...
    m_strengthLabel->setStyleSheet("font-size: 11px;");
...
void RegisterWidget::onPasswordChanged(const QString& text)
{
    ...
    if (len < 6)
        m_strengthLabel->setStyleSheet("color: #f85149; font-size: 11px;"),
        m_strengthLabel->setText("Contraseña débil");
    else if (len < 10)
        m_strengthLabel->setStyleSheet("color: #d29922; font-size: 11px;"),
        m_strengthLabel->setText("Contraseña media");
    else
        m_strengthLabel->setStyleSheet("color: #3fb950; font-size: 11px;"),
