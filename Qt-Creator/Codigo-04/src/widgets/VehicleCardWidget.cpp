...
void VehicleCardWidget::setupUI()
{
    ...
    m_thumbnail->setStyleSheet(
        "background: #21262d; border-radius: 6px; color: #484f58; font-size: 24px;");
    m_thumbnail->setText("🚗");
    ...
    m_dateLabel = new QLabel(
        ...
        : "Fecha desconocida",
        this);
    m_dateLabel->setStyleSheet("color: #484f58; font-size: 11px;");
    ...
    m_confidenceLabel->setStyleSheet(
        ...
        "padding: 2px 8px; color: #8b949e; font-size: 11px;");
    ...
    if (m_vehicle.hasAnalysis()) {
        ...
        aiBadge->setStyleSheet(
            ...
            "padding: 2px 8px; color: #58a6ff; font-size: 11px;");
