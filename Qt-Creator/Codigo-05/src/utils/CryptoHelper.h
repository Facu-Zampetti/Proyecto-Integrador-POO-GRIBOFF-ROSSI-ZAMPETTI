...
public:
    ...
    // ── MD5 ───────────────────────────────────────────────────────────
    /// Calcula el MD5 de un string. Uso: checksums de texto/metadata.
    static QString md5(const QString& text);

    /// Calcula el MD5 de un archivo en disco. Retorna hex digest o "" si error.
    /// Uso: verificar integridad de imágenes/capturas al persistirlas.
